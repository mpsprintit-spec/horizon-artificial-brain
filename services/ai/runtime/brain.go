...
// It is a view/operation boundary, never a second memory store.
func (r *BrainRuntime) DNF() *dnf.Fabric {
	if r == nil { return nil }
	return r.dnf
}
